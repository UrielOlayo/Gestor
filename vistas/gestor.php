...
?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" id="frmArchivos" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tablaGestorArchivos').load("tablaGestor.php"); //cargamos la tabla que esta en tablaGestor.php
            $('#categoriasLoad').load("selectCategorias.php");
